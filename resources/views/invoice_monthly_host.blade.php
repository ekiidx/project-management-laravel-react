...
<div class="main">
    ...
    <div style="display: flex; justify-content: space-between; margin-bottom: 4rem;">
        ...
        <div style="padding-top: 1rem;">
            ...
            <span style="display: block; font-size: 0.85rem;">111.222.3333</span>
            <span style="display: block; font-size: 0.85rem;">project-management.co</span>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td class="table-row">Monthly Hosting</td>
                <td class="table-row">{{$date}}</td>
                <td class="table-row">1</td>
                <td class="table-row price">$10.00</td>
                <td class="table-row price">$10.00</td>
            </tr>
        </tbody>
    </table>
...
<div class="main" style="position: absolute; bottom: 0;">
    ...
    <div style="margin-bottom: 1rem;">
        ...
        <span style="display: block; font-size: 0.85rem;">PAYPAL - $$$</span>
        <span style="display: block; font-size: 0.85rem;">CASH APP - $$$</span>
    </div>

    <div style="margin-bottom: 1rem;">
        <h3 style="margin-bottom: 0.1rem; font-size: 0.9rem;">THANK YOU</h2>
        <span style="display: block;">Vue Design</span>
        <span style="display: block; font-size: 0.85rem;">Address</span>
        <span style="display: block; font-size: 0.85rem;">City, State Zipcode</span>
    </div>
</div>